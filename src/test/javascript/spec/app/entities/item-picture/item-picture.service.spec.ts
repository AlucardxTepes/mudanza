...
describe('Service Tests', () => {
  describe('ItemPicture Service', () => {
    let injector: TestBed;
    let service: ItemPictureService;
    let httpMock: HttpTestingController;
    let elemDefault: IItemPicture;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ItemPictureService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new ItemPicture(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of ItemPicture', () => {
        const returnedFromService = Object.assign(
          {
            filename: 'BBBBBB'
          },
